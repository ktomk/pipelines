...
#
# pipelines:php7.4 docker image
#
# usage: ./php7.4.sh [<docker-cmd>]
#
...
# to copy-from the standard php:7.4 container.
#
set -euo pipefail
IFS=$' \n\t'

docker_cmd="${1-docker}"
from="docker.io/php:7.4"
tag="docker.io/ktomk/pipelines:php7.4"
