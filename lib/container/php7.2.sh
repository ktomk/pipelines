...
#
# pipelines:php7.2 docker image
#
# usage: ./php7.2.sh [<docker-cmd>]
#
...
# to copy-from the standard php:7.2 container.
#
set -euo pipefail
IFS=$' \n\t'

docker_cmd="${1-docker}"
from="docker.io/php:7.2"
tag="docker.io/ktomk/pipelines:php7.2"
