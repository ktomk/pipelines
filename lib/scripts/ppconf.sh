...
#
# examples:
#     ./lib/scripts/ppconf.sh help
#     ./lib/scripts/ppconf.sh self-test
#     ./lib/scripts/ppconf.sh disable-tls
#     ./lib/scripts/ppconf.sh patch-phpunit-tests
#     ./lib/scripts/ppconf.sh downpatch-phpunit-tests
#     ./lib/scripts/ppconf.sh phpunit-version ^4
#     ./lib/scripts/ppconf.sh remove-dev kubawerlos/php-cs-fixer-custom-fixers
#     ./lib/scripts/ppconf.sh xdebug3
#
set -eu
IFS=$(printf '\n \t')
