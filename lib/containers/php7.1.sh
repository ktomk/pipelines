...
#
# pipelines:php7.1 docker image
#
# usage: ./php7.1.sh [<docker-cmd>]
#
...
# to copy-from the standard php:7.1 container.
#
set -euo pipefail
IFS=$' \n\t'

docker_cmd="${1-docker}"
from="docker.io/php:7.1"
tag="docker.io/ktomk/pipelines:php7.1"
